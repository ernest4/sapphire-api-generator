...
const { randomName, randomDate, randomNumber } = require("../../../seedData/seeds");
...
function generateSaveFields(asset, model) {
...
function assignValueToField(asset, field) {
  ...
  switch (type) {
    ...
    default:
      ...
      generation. Please write custom tests for this model!
      ...
      generation, but will NOT include this type in tests!
...
function generateString(field) {
  // if (field.hasOwnProperty("default")) return generateDefaultValue(field);
