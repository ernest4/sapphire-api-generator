...
function generateTestCaseGET(asset, options, model) {
  ...
  // const fields = generateSaveFields(asset, model);
...
function generateShouldLines(saveFieldsObject) {
  ...
  let finalShouldLinesString = `// currently this isn't meant to be exhaustive, rather a quick check that object is
            // mostly what it should be...`;

  for (let field in saveFieldsObject) {
    finalShouldLinesString += `
    ${saveFieldsObject[field]}`;
  }
