...
function createModelFileSync(asset, options) {
  try {
    ...
    //   return `  created: ${gitignorePath}`;
    // }
    return `model:      ${options.apiv}/models/${asset}.model.js`;
  } catch (err) {
    throw new Error(err);
  }
}
...
function createRoutesFileSync(asset, options) {
  ...
  try {
    ...
    //   return `  created: ${gitignorePath}`;
    // }
    return `routes:     ${options.apiv}/routes/${asset}.routes.js`;
  } catch (err) {
    throw new Error(err);
  }
}
...
function createServiceFileSync(asset, options) {
  ...
  try {
    ...
    //   return `  created: ${gitignorePath}`;
    // }
    return `service:    ${options.apiv}/services/${asset}.service.js`;
  } catch (err) {
    throw new Error(err);
  }
}
